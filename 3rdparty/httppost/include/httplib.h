...
inline ssize_t select_read(socket_t sock, time_t sec, time_t usec) {
  ...
  //std::cout << "Select Read poll..." << std::endl;
  ...
  std::cout << "Select Read select..." << std::endl;
  return handle_EINTR([&]() {
...
inline ssize_t select_write(socket_t sock, time_t sec, time_t usec) {
  ...
  //std::cout << "Select Write poll..." << std::endl;
  return handle_EINTR([&]() { return poll(&pfd_read, 1, timeout); });
#else
#ifndef _WIN32
  if (sock >= FD_SETSIZE) { return 1; }
  ...
  std::cout << "Select Write select..." << std::endl;
  return handle_EINTR([&]() {
...
inline Error wait_until_socket_is_ready(socket_t sock, time_t sec,
  ...
  std::cout << "Wait Socket ready poll..." << std::endl;
...
#else
#ifndef _WIN32
  std::cout << sock << " " << FD_SETSIZE << std::endl;
  ...
  std::cout << "Wait Socket ready select..." << std::endl;
